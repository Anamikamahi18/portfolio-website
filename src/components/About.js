...
const ANAMIKA_FAQ = [
  ...
  { key: "projects", answer: "I have built an Recipe Sharing Platform, OTT Streaming Platform, Personal Bookmarking Site, Daily Water Intake Tracker etc." },
  ...
  { key: "github repos", answer: "Some of my public repositories: OTT-Streaming-Platform, Water-Intake-Tracker, Recipe Sharing Platform, Personal Bookmarking Site, Daily Water Intake Tracker, Calculator, Scientific Calculator etc." },
  ...
  { key: "achievements", answer: "Completed projects, internships and certifications. Always eager to learn and grow." },
    ...
    >
      <div className="container mx-auto flex flex-col md:flex-row gap-10 items-center px-4 sm:px-8">
        ...
        <div className="w-full max-w-xl mx-auto">
          ...
          <p className="mb-2 text-base dark:text-gray-200">Full Stack Developer Intern at <span className="font-semibold">MashupStack</span></p>
          <p className="mb-2 text-base dark:text-gray-200">M.Sc. Mathematics, Mar Ivanios College, Thiruvananthapuram</p>
          <p className="mb-4 text-base dark:text-gray-200">I enjoy building apps with <span className="font-semibold">React</span> & <span className="font-semibold">Django</span>, and I'm passionate about learning new technologies and solving real-world problems. My goal is to create impactful digital experiences with clean, efficient code.</p>
          <a
